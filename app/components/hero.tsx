      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:mb-10 mb-5">
          <button  onClick={() => setOpen(true)}  
            className="group relative sm:px-8 px-4 py-4 bg-gradient-to-r
              from-orange-500
              via-[#ff7b00]
              to-blue-600 text-white font-bold text-lg rounded-full overflow-hidden shadow-2xl shadow-orange-500/30 hover:shadow-orange-500/50 hover:scale-105 transition-all duration-300"
          >
