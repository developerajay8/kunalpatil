                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-1">
                        ...
                        <button
                            ...
                            className="ml-3 px-5 py-2.5 cursor-pointer bg-gradient-to-r
                    from-orange-500
                    via-[#ff7b00]
                    to-blue-600 text-white text-sm font-semibold rounded-full hover:shadow-lg hover:shadow-orange-500/40 hover:scale-105 transition-all duration-200"
                        >
                            Start Now →
                        </button>
                    </nav>
                ...
                {menuOpen && (
                    <div className="md:hidden bg-[#0d0d0d]/95 backdrop-blur-xl border-t border-orange-500/20 px-4 py-4 space-y-1">
                        ...
                        <button onClick={() => setOpen(true)}
                            ...
                            className="w-full mt-2 cursor-pointer px-5 py-3 bg-gradient-to-r
                    from-orange-500
                    via-[#ff7b00]
                    to-blue-600 text-white font-semibold rounded-full"
                        >
                            Start Now →
                        </button>
