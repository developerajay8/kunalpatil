  ...
  return (
    <section className="w-full bg-[#0a0a0a] pt-10 sm:pt-20">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        {/* Text */}
        <div className="text-center mt-10 text-gray-300 text-sm md:text-base max-w-xl mx-auto">
          <p>
        ...
        <div className="text-center mt-10 pb-12">
              ...
              <button className="bg-[#f35113] cursor-pointer text-white sm:px-8 px-4 sm:py-4 py-3 rounded-full text-lg font-medium shadow-lg hover:scale-105 transition">
